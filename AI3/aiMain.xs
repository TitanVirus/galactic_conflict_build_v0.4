...
void initArrays(void)
{
   ...
   gMapNames = xsArrayCreateString(50, "", "Map names");
     ...
     gTargetSettlerCounts = xsArrayCreateInt(cAge5+1, 0, "Target Settler Counts");
      ...
      xsArraySetInt(gTargetSettlerCounts, cAge4, 95);
      xsArraySetInt(gTargetSettlerCounts, cAge5, 95);
...
{ 
   ...
   if ( cvPrimaryArmyUnit >= 0 )
   {
      ...
      else  // Three lines selected
      {
         ...
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cvPrimaryArmyUnit, 0.8);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cvSecondaryArmyUnit, 0.4);         
   ...
   if (counterUnitMode == false)
   {
      ...
      { //Elephants are soooo expensive
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypMercFlailiphant, 0.99);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypNatMercGurkha, 0.99);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypSepoy, 0.90 + (btBiasInf / 2.0));
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractSowar, 0.99 + (btBiasCav / 2.0));
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractZamburak, 0.99 + (btBiasCav / 2.0));
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractHowdah, 0.60 + (btBiasCav / 2.0));
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypMahout, 0.10);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypRajput, 0.10);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypUrumi, 0.10);
      }
      if (cMyCiv == cCivBritish) 
      {
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHussar, 0.85);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeDragoon, 0.92);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeMusketeer, 0.91);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeGrenadier, 0.85);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypePikeman, 0.1);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeLongbowman, 0.1);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeSkirmisher, 0.1);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHalberdier, 0.1);
      }
      if (cMyCiv == cCivPortuguese) 
      {
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeMusketeer, 0.91);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeCacadore, 0.92);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHalberdier, 0.80);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHussar, 0.70);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeDragoon, 0.85);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypePikeman, 0.1);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeOrganGun, 0.50);
      }
      if (cMyCiv == cCivRussians) 
      {
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractRangedInfantry, 0.93);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeCossack, 0.91);
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHalberdier, 0.85);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeCavalryArcher, 0.75);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeOprichnik, 0.10);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeGrenadier, 0.10);
      }
      if (cMyCiv == cCivSpanish) 
      {
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeLancer, 0.85);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeDragoon, 0.93);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeRodelero, 0.88);
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeMusketeer, 0.90);
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeSkirmisher, 0.90);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHussar, 0.70);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypePikeman, 0.10);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHalberdier, 0.10);
      }
      if (cMyCiv == cCivDutch) 
      {
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHussar, 0.93 + (btBiasCav / 2.0));
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHalberdier, 0.93 + (btBiasInf / 2.0));
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeRuyter, 0.99 + (btBiasCav / 2.0));
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeSkirmisher, 0.90 + (btBiasInf / 2.0));
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypePikeman, 0.2);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeGrenadier, 0.10);
      }
      if (cMyCiv == cCivOttomans) 
      {
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHussar, 0.90);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeCavalryArcher, 0.90);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeJanissary, 0.91);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbusGun, 0.70);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeGrenadier, 0.10);
	 }
      if (cMyCiv == cCivFrench) 
      {
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeCuirassier, 0.90);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeDragoon, 0.92);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeMusketeer, 0.91);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeSkirmisher, 0.90);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHalberdier, 0.70);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeHussar, 0.60);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypePikeman, 0.1);
	 }
      if (cMyCiv == cCivXPIroquois) 
      {
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpAenna, 0.85);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpTomahawk, 0.95);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpMusketWarrior, 0.88);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpMantlet, 0.80);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpHorseman, 0.75);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpMusketRider, 0.20);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpLightCannon, 0.20);
	 }	 
      if (cMyCiv == cCivXPSioux) 
      {
      ...
      if ( (kbGetCiv() == cCivChinese) || (kbGetCiv() == cCivSPCChinese) ) 
      {
         ...
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypTerritorialArmy, 0.90);   // Range 0.0 to 1.0
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypForbiddenArmy, 0.80);
         //kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypOldHanArmy, 0.1);   // Range 0.0 to 1.0
         //kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypImperialArmy, 0.6);   // Range 0.0 to 1.0
         //kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypBlackFlagArmy, 0.6);
         //kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypMongolianArmy, 0.6);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractArtillery, 0.0);
      }
      ...
      {
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypKensei, 0.99);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypNaginataRider, 0.99);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypFlamingArrow, 0.5);
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypYumi, 0.01);
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypAshigaru, 0.01);
	     kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypYabusame, 0.01);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeMercenary, 0.0);
      }

      if ( (kbGetCiv() == cCivGermans) || (kbGetCiv() == cCivGermans) )
      {
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeUhlan, 0.88);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeDopplesoldner, 0.88);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeWarWagon, 0.90);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeSkirmisher, 0.90);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypePikeman, 0.2);		 
      }

      if ((civIsEmpire() == true) || (civIsEmpire() == true))
      {
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractHandInfantry, 0.5); // Melee Troopers
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractHeavyInfantry, 0.8); // Troopers
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractLightInfantry, 0.6); //Snipers
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractSiegeTrooper, 0.6);   // Siege Troopers
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezTIEMauler, 0.6);
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezTX225Tank, 0.6);
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezImperialScoutWalker, 0.7);
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezATAT, 0.7);
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezATAA, 0.6);
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezSPMA, 0.6);
		kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractSepoy, 0.2); 
      }
      ...
      { 
         ...
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypDacoit, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypThuggee, 0.0);		
         ...
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateCarabineer, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateStadhouders, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateRedcoat, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateRogersRanger, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateLifeGuard, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateZweihander, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateCzapakaUhlan, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateGendarmes, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateTufanciCorps, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateJinete, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateGuerreiros, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateBestieros, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateEspadachins, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateTercio, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeypConsulateSiberianCossack, 0.0);		 		 
	 }
      ...
      { 
         ...
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeMercStradiot, 0.0);	 		 		 
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeMercRonin, 0.0);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpSpy, 0.25);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeCulverin, 0.25);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeFalconet, 0.25);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypexpHorseArtillery, 0.25);
         kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeCrossbowman, 0.2);
		 }
   }
}
...
minInterval 3
{
   ...
   if ( (kbGetPopCap()-kbGetPop()) > 20 ) // If we're OK on houses...
   {
	...
	//Give storehouse to Factions, if Homesteads are already built and population count is good
  
  if ( (civIsEmpire() == true) && (kbUnitCount(cMyID, cUnitTypezHomestead, cUnitStateABQ) < 1))
   {
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezStorehouse);
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezStorehouse, cUnitStateAlive) < 1) )
      { 
         createSimpleBuildPlan(cUnitTypezStorehouse, 1, 60, true, cEconomyEscrowID, kbBaseGetMainID(cMyID), 1);
         aiEcho("Starting a storehouse build plan.");
      }   
   }
   
	//If enough Homesteads are built and population count is good, and I can afford, I should build a barracks
  
  if ( (civIsEmpire() == true) && (kbUnitCount(cMyID, cUnitTypezHomestead, cUnitStateABQ) < 3))
   {
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezInfantryBarracks);
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezInfantryBarracks, cUnitStateAlive) < 1) )
      { 
         createSimpleBuildPlan(cUnitTypezInfantryBarracks, 1, 60, true, cEconomyEscrowID, kbBaseGetMainID(cMyID), 1);
         aiEcho("Starting a infantry barracks build plan.");
      }   
   }
   ...
   if (civIsAsian() == true) {
    ...
    // Set SW:GC major faction's buildplan for tech level 2
   if (civIsEmpire() == true)
   {
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezAirbase); //At least one Airbase
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezAirbase, cUnitStateAlive) < 1) )
      {
         createSimpleBuildPlan(cUnitTypezAirbase, 1, 60, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
         aiEcho("Starting a Airbase build plan.");
      }
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezVehicleWorkshop); //At least one Light Factory
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezVehicleWorkshop, cUnitStateAlive) < 1) )
      {
         createSimpleBuildPlan(cUnitTypezVehicleWorkshop, 1, 70, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
         aiEcho("Starting a LVF build plan.");
      }
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezInfantryBarracks); //Additional Barracks
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezInfantryBarracks, cUnitStateAlive) < 2) )
      {
   ...
   if (civIsEmpire() == true)
   {
      ...
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezVehicleWorkshop, cUnitStateAlive) < 2) )
      {
         createSimpleBuildPlan(cUnitTypezVehicleWorkshop, 1, 50, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
         aiEcho("Starting a LVF build plan.");
      }
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezResearchFacility); //At least one research facility
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezResearchFacility, cUnitStateAlive) < 1) )
      {
 ...
 // Set SW:GC major faction's buildplan for tech level 4
   if (civIsEmpire() == true)
   {
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezWeaponsFactory); //At least two Heavy Factories
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezWeaponsFactory, cUnitStateAlive) < 2) )
      {
         createSimpleBuildPlan(cUnitTypezWeaponsFactory, 2, 70, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
         aiEcho("Starting a Heavy Factory build plan.");
      }
	  planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezInfantryBarracks); // One more barracks
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezInfantryBarracks, cUnitStateAlive) < 3) )
      {
         createSimpleBuildPlan(cUnitTypezInfantryBarracks, 1, 50, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
      ...
      {
         createSimpleBuildPlan(cUnitTypezAirbase, 1, 50, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
